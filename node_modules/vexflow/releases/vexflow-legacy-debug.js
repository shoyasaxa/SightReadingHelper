...
var RuntimeError = function () {
  ...
  RuntimeError.prototype.toString = function toString() {
...
var Glyph = exports.Glyph = function (_Element) {
  ...
  Glyph.loadMetrics = function loadMetrics(font, code, cache) {
  ...
  Glyph.renderGlyph = function renderGlyph(ctx, x_pos, y_pos, point, val, nocache) {
  ...
  Glyph.renderOutline = function renderOutline(ctx, outline, scale, x_pos, y_pos) {
    ctx.beginPath();
  ...
  Glyph.getOutlineBoundingBox = function getOutlineBoundingBox(outline, scale, x_pos, y_pos) {
  ...
  Glyph.prototype.setOptions = function setOptions(options) {
    _vex.Vex.Merge(this.options, options);
    this.reset();
  };

  Glyph.prototype.setPoint = function setPoint(point) {
    this.point = point;return this;
  };

  Glyph.prototype.setStave = function setStave(stave) {
    this.stave = stave;return this;
  };

  Glyph.prototype.setXShift = function setXShift(x_shift) {
    this.x_shift = x_shift;return this;
  };

  Glyph.prototype.setYShift = function setYShift(y_shift) {
    this.y_shift = y_shift;return this;
  };

  Glyph.prototype.reset = function reset() {
  ...
  Glyph.prototype.getMetrics = function getMetrics() {
    if (!this.metrics) {
  ...
  Glyph.prototype.setOriginX = function setOriginX(x) {
    var bbox = this.bbox;
  ...
  Glyph.prototype.setOriginY = function setOriginY(y) {
    var bbox = this.bbox;
  ...
  Glyph.prototype.setOrigin = function setOrigin(x, y) {
    this.setOriginX(x);
    this.setOriginY(y);
  };

  Glyph.prototype.render = function render(ctx, x, y) {
    if (!this.metrics) {
      throw new _vex.Vex.RuntimeError('BadGlyph', 'Glyph ' + this.code + ' is not initialized.');
    }
  ...
  Glyph.prototype.renderToStave = function renderToStave(x) {
    this.checkContext();
...
var Element = exports.Element = function () {
  ...
  Element.prototype.getStyle = function getStyle() {
    return this.style;
  };
  ...
  Element.prototype.applyStyle = function applyStyle() {
  ...
  Element.prototype.restoreStyle = function restoreStyle() {
    var context = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.context;
    var style = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : this.getStyle();
  ...
  Element.prototype.onRegister = function onRegister(registry) {
  ...
  Element.prototype.checkContext = function checkContext() {
    if (!this.context) {
...
var Modifier = exports.Modifier = function (_Element) {
  ...
  Modifier.prototype.getCategory = function getCategory() {
  ...
  Modifier.prototype.getWidth = function getWidth() {
    return this.width;
  };

  Modifier.prototype.setWidth = function setWidth(width) {
  ...
  Modifier.prototype.getNote = function getNote() {
    return this.note;
  };

  Modifier.prototype.setNote = function setNote(note) {
  ...
  Modifier.prototype.getIndex = function getIndex() {
    return this.index;
  };

  Modifier.prototype.setIndex = function setIndex(index) {
  ...
  Modifier.prototype.getModifierContext = function getModifierContext() {
    return this.modifier_context;
  };

  Modifier.prototype.setModifierContext = function setModifierContext(c) {
  ...
  Modifier.prototype.getPosition = function getPosition() {
    return this.position;
  };

  Modifier.prototype.setPosition = function setPosition(position) {
  ...
  Modifier.prototype.setTextLine = function setTextLine(line) {
  ...
  Modifier.prototype.setYShift = function setYShift(y) {
    this.y_shift = y;return this;
  };

  Modifier.prototype.setSpacingFromNextModifier = function setSpacingFromNextModifier(x) {
    this.spacingFromNextModifier = x;
  };

  Modifier.prototype.getSpacingFromNextModifier = function getSpacingFromNextModifier() {
  ...
  Modifier.prototype.setXShift = function setXShift(x) {
    this.x_shift = 0;
  ...
  Modifier.prototype.getXShift = function getXShift() {
    return this.x_shift;
  };
  ...
  Modifier.prototype.draw = function draw() {
    this.checkContext();
  ...
  Modifier.prototype.alignSubNotesWithNote = function alignSubNotesWithNote(subNotes, note) {
...
var StaveNote = exports.StaveNote = function (_StemmableNote) {
  ...
  StaveNote.format = function format(notes, state) {
  ...
  StaveNote.formatByY = function formatByY(notes, state) {
  ...
  StaveNote.postFormat = function postFormat(notes) {
  ...
  function StaveNote(noteStruct) {
    ...
    var _this = _possibleConstructorReturn(this, _StemmableNote.call(this, noteStruct));
  ...
  StaveNote.prototype.reset = function reset() {
    var _this2 = this;

    _StemmableNote.prototype.reset.call(this);
  ...
  StaveNote.prototype.getCategory = function getCategory() {
  ...
  StaveNote.prototype.buildNoteHeads = function buildNoteHeads() {
    this.note_heads = [];
  ...
  StaveNote.prototype.autoStem = function autoStem() {
  ...
  StaveNote.prototype.calculateKeyProps = function calculateKeyProps() {
    var lastLine = null;
  ...
  StaveNote.prototype.getBoundingBox = function getBoundingBox() {
  ...
  StaveNote.prototype.getLineNumber = function getLineNumber(isTopNote) {
  ...
  StaveNote.prototype.isRest = function isRest() {
  ...
  StaveNote.prototype.isChord = function isChord() {
  ...
  StaveNote.prototype.hasStem = function hasStem() {
    return this.glyph.stem;
  };

  StaveNote.prototype.hasFlag = function hasFlag() {
    return _StemmableNote.prototype.hasFlag.call(this) && !this.isRest();
  };

  StaveNote.prototype.getStemX = function getStemX() {
    if (this.noteType === 'r') {
      return this.getCenterGlyphX();
    } else {
      // We adjust the origin of the stem because we want the stem left-aligned
      // with the notehead if stemmed-down, and right-aligned if stemmed-up
      return _StemmableNote.prototype.getStemX.call(this) + getStemAdjustment(this);
    }
  };
  ...
  StaveNote.prototype.getYForTopText = function getYForTopText(textLine) {
    var extents = this.getStemExtents();
    return Math.min(this.stave.getYForTopText(textLine), extents.topY - this.render_options.annotation_spacing * (textLine + 1));
  };

  StaveNote.prototype.getYForBottomText = function getYForBottomText(textLine) {
    var extents = this.getStemExtents();
  ...
  StaveNote.prototype.setStave = function setStave(stave) {
    _StemmableNote.prototype.setStave.call(this, stave);
  ...
  StaveNote.prototype.getKeys = function getKeys() {
    return this.keys;
  };
  ...
  StaveNote.prototype.getKeyProps = function getKeyProps() {
  ...
  StaveNote.prototype.isDisplaced = function isDisplaced() {
  ...
  StaveNote.prototype.setNoteDisplaced = function setNoteDisplaced(displaced) {
  ...
  StaveNote.prototype.getTieRightX = function getTieRightX() {
  ...
  StaveNote.prototype.getTieLeftX = function getTieLeftX() {
  ...
  StaveNote.prototype.getLineForRest = function getLineForRest() {
  ...
  StaveNote.prototype.getModifierStartXY = function getModifierStartXY(position, index) {
    if (!this.preFormatted) {
  ...
  StaveNote.prototype.setStyle = function setStyle(style) {
    _StemmableNote.prototype.setStyle.call(this, style);
  ...
  StaveNote.prototype.setStemStyle = function setStemStyle(style) {
    var stem = this.getStem();
    stem.setStyle(style);
  };

  StaveNote.prototype.getStemStyle = function getStemStyle() {
    return this.stem.getStyle();
  };

  StaveNote.prototype.setLedgerLineStyle = function setLedgerLineStyle(style) {
    this.ledgerLineStyle = style;
  };

  StaveNote.prototype.getLedgerLineStyle = function getLedgerLineStyle() {
    return this.ledgerLineStyle;
  };

  StaveNote.prototype.setFlagStyle = function setFlagStyle(style) {
    this.flagStyle = style;
  };

  StaveNote.prototype.getFlagStyle = function getFlagStyle() {
  ...
  StaveNote.prototype.setKeyStyle = function setKeyStyle(index, style) {
    this.note_heads[index].setStyle(style);
    return this;
  };

  StaveNote.prototype.setKeyLine = function setKeyLine(index, line) {
    this.keyProps[index].line = line;
    this.reset();
    return this;
  };

  StaveNote.prototype.getKeyLine = function getKeyLine(index) {
  ...
  StaveNote.prototype.addToModifierContext = function addToModifierContext(mContext) {
  ...
  StaveNote.prototype.addModifier = function addModifier(index, modifier) {
  ...
  StaveNote.prototype.addAccidental = function addAccidental(index, accidental) {
  ...
  StaveNote.prototype.addArticulation = function addArticulation(index, articulation) {
  ...
  StaveNote.prototype.addAnnotation = function addAnnotation(index, annotation) {
  ...
  StaveNote.prototype.addDot = function addDot(index) {
  ...
  StaveNote.prototype.addDotToAll = function addDotToAll() {
    for (var i = 0; i < this.keys.length; ++i) {
      this.addDot(i);
    }
    return this;
  ...
  StaveNote.prototype.getAccidentals = function getAccidentals() {
  ...
  StaveNote.prototype.getDots = function getDots() {
  ...
  StaveNote.prototype.getVoiceShiftWidth = function getVoiceShiftWidth() {
  ...
  StaveNote.prototype.calcExtraPx = function calcExtraPx() {
  ...
  StaveNote.prototype.preFormat = function preFormat() {
  ...
  StaveNote.prototype.getNoteHeadBounds = function getNoteHeadBounds() {
  ...
  StaveNote.prototype.getNoteHeadBeginX = function getNoteHeadBeginX() {
  ...
  StaveNote.prototype.getNoteHeadEndX = function getNoteHeadEndX() {
  ...
  StaveNote.prototype.drawLedgerLines = function drawLedgerLines() {
  ...
  StaveNote.prototype.drawModifiers = function drawModifiers() {
    if (!this.context) {
      throw new _vex.Vex.RERR('NoCanvasContext', "Can't draw without a canvas context.");
    }
  ...
  StaveNote.prototype.drawFlag = function drawFlag() {
    var stem = this.stem,
        beam = this.beam,
        ctx = this.context;
  ...
  StaveNote.prototype.drawNoteHeads = function drawNoteHeads() {
    var _this3 = this;
  ...
  StaveNote.prototype.drawStem = function drawStem(stemStruct) {
  ...
  StaveNote.prototype.draw = function draw() {
    if (!this.context) {
      throw new _vex.Vex.RERR('NoCanvasContext', "Can't draw without a canvas context.");
    }
    if (!this.stave) {
...
var Note = exports.Note = function (_Tickable) {
  ...
  // note.
  Note.plotMetrics = function plotMetrics(ctx, note, yPos) {
  ...
  Note.prototype.getPlayNote = function getPlayNote() {
    return this.playNote;
  };

  Note.prototype.setPlayNote = function setPlayNote(note) {
  ...
  Note.prototype.isRest = function isRest() {
    return false;
  };
  ...
  Note.prototype.addStroke = function addStroke(index, stroke) {
    stroke.setNote(this);
  ...
  Note.prototype.getStave = function getStave() {
    return this.stave;
  };

  Note.prototype.setStave = function setStave(stave) {
    this.stave = stave;
  ...
  Note.prototype.getCategory = function getCategory() {
  ...
  Note.prototype.setContext = function setContext(context) {
    this.context = context;return this;
  };
  ...
  Note.prototype.getExtraLeftPx = function getExtraLeftPx() {
    return this.extraLeftPx;
  };

  Note.prototype.getExtraRightPx = function getExtraRightPx() {
    return this.extraRightPx;
  };

  Note.prototype.setExtraLeftPx = function setExtraLeftPx(x) {
    this.extraLeftPx = x;return this;
  };

  Note.prototype.setExtraRightPx = function setExtraRightPx(x) {
  ...
  Note.prototype.shouldIgnoreTicks = function shouldIgnoreTicks() {
  ...
  Note.prototype.getLineNumber = function getLineNumber() {
    return 0;
  };
  ...
  Note.prototype.getLineForRest = function getLineForRest() {
    return 0;
  };
  ...
  Note.prototype.getGlyph = function getGlyph() {
    return this.glyph;
  };

  Note.prototype.getGlyphWidth = function getGlyphWidth() {
  ...
  Note.prototype.setYs = function setYs(ys) {
    this.ys = ys;return this;
  };

  Note.prototype.getYs = function getYs() {
    if (this.ys.length === 0) {
      throw new _vex.Vex.RERR('NoYValues', 'No Y-values calculated for this note.');
    }
  ...
  Note.prototype.getYForTopText = function getYForTopText(text_line) {
    if (!this.stave) {
  ...
  Note.prototype.getBoundingBox = function getBoundingBox() {
    return null;
  };
  ...
  Note.prototype.getVoice = function getVoice() {
  ...
  Note.prototype.setVoice = function setVoice(voice) {
    this.voice = voice;
  ...
  Note.prototype.getTickContext = function getTickContext() {
    return this.tickContext;
  };

  Note.prototype.setTickContext = function setTickContext(tc) {
    this.tickContext = tc;
    this.preFormatted = false;
    return this;
  };
  ...
  Note.prototype.getDuration = function getDuration() {
    return this.duration;
  };

  Note.prototype.isDotted = function isDotted() {
    return this.dots > 0;
  };

  Note.prototype.hasStem = function hasStem() {
    return false;
  };

  Note.prototype.getDots = function getDots() {
    return this.dots;
  };

  Note.prototype.getNoteType = function getNoteType() {
  ...
  Note.prototype.setModifierContext = function setModifierContext(mc) {
  ...
  Note.prototype.addModifier = function addModifier(modifier) {
  ...
  Note.prototype.getModifierStartXY = function getModifierStartXY() {
    if (!this.preFormatted) {
      throw new _vex.Vex.RERR('UnformattedNote', "Can't call GetModifierStartXY on an unformatted note");
    }
  ...
  Note.prototype.getMetrics = function getMetrics() {
    if (!this.preFormatted) {
  ...
  Note.prototype.setWidth = function setWidth(width) {
    this.width = width;
  };

  Note.prototype.getWidth = function getWidth() {
    if (!this.preFormatted) {
  ...
  Note.prototype.setXShift = function setXShift(x) {
    this.x_shift = x;return this;
  };

  Note.prototype.getXShift = function getXShift() {
    return this.x_shift;
  };
  ...
  Note.prototype.getX = function getX() {
    if (!this.tickContext) {
  ...
  Note.prototype.getAbsoluteX = function getAbsoluteX() {
    if (!this.tickContext) {
      throw new _vex.Vex.RERR('NoTickContext', 'Note needs a TickContext assigned for an X-Value');
    }
  ...
  Note.prototype.setPreFormatted = function setPreFormatted(value) {
...
var StaveModifier = exports.StaveModifier = function (_Element) {
  ...
  StaveModifier.prototype.getPosition = function getPosition() {
    return this.position;
  };

  StaveModifier.prototype.setPosition = function setPosition(position) {
    this.position = position;return this;
  };

  StaveModifier.prototype.getStave = function getStave() {
    return this.stave;
  };

  StaveModifier.prototype.setStave = function setStave(stave) {
    this.stave = stave;return this;
  };

  StaveModifier.prototype.getWidth = function getWidth() {
    return this.width;
  };

  StaveModifier.prototype.setWidth = function setWidth(width) {
    this.width = width;return this;
  };

  StaveModifier.prototype.getX = function getX() {
    return this.x;
  };

  StaveModifier.prototype.setX = function setX(x) {
    this.x = x;return this;
  };

  StaveModifier.prototype.getCategory = function getCategory() {
    return '';
  };

  StaveModifier.prototype.makeSpacer = function makeSpacer(padding) {
  ...
  StaveModifier.prototype.placeGlyphOnLine = function placeGlyphOnLine(glyph, stave, line) {
    glyph.setYShift(stave.getYForLine(line) - stave.getYForGlyphs());
  };

  StaveModifier.prototype.getPadding = function getPadding(index) {
    return index !== undefined && index < 2 ? 0 : this.padding;
  };

  StaveModifier.prototype.setPadding = function setPadding(padding) {
...
var Fraction = function () {
  ...
  Fraction.LCMM = function LCMM(args) {
    if (args.length === 0) {
      return 0;
  ...
  Fraction.prototype.set = function set(numerator, denominator) {
    this.numerator = numerator === undefined ? 1 : numerator;
    this.denominator = denominator === undefined ? 1 : denominator;
    return this;
  };

  Fraction.prototype.value = function value() {
    return this.numerator / this.denominator;
  };

  Fraction.prototype.simplify = function simplify() {
  ...
  Fraction.prototype.add = function add(param1, param2) {
  ...
  Fraction.prototype.subtract = function subtract(param1, param2) {
    var otherNumerator = void 0;
    var otherDenominator = void 0;
  ...
  Fraction.prototype.multiply = function multiply(param1, param2) {
    var otherNumerator = void 0;
    var otherDenominator = void 0;
  ...
  Fraction.prototype.divide = function divide(param1, param2) {
    var otherNumerator = void 0;
    var otherDenominator = void 0;
  ...
  Fraction.prototype.equals = function equals(compare) {
  ...
  Fraction.prototype.greaterThan = function greaterThan(compare) {
  ...
  Fraction.prototype.greaterThanEquals = function greaterThanEquals(compare) {
    var a = Fraction.__compareB.copy(this);
    a.subtract(compare);
    return a.numerator >= 0;
  };
  ...
  Fraction.prototype.lessThan = function lessThan(compare) {
  ...
  Fraction.prototype.lessThanEquals = function lessThanEquals(compare) {
  ...
  Fraction.prototype.copy = function copy(_copy) {
  ...
  Fraction.prototype.quotient = function quotient() {
  ...
  Fraction.prototype.fraction = function fraction() {
    return this.numerator % this.denominator;
  };
  ...
  Fraction.prototype.toSimplifiedString = function toSimplifiedString() {
  ...
  Fraction.prototype.toMixedString = function toMixedString() {
    var s = '';
    var q = this.quotient();
  ...
  Fraction.prototype.parse = function parse(str) {
    var i = str.split('/');
...
var Formatter = exports.Formatter = function () {
  ...
  Formatter.plotDebugging = function plotDebugging(ctx, formatter, xPos, y1, y2) {
  ...
  Formatter.FormatAndDrawTab = function FormatAndDrawTab(ctx, tabstave, stave, tabnotes, notes, autobeam, params) {
    var opts = {
      auto_beam: autobeam,
      align_rests: false
    };
  ...
  Formatter.AlignRestsToNotes = function AlignRestsToNotes(notes, alignAllNotes, alignTuplets) {
  ...
  Formatter.prototype.alignRests = function alignRests(voices, alignAllNotes) {
    if (!voices || !voices.length) {
  ...
  Formatter.prototype.preCalculateMinTotalWidth = function preCalculateMinTotalWidth(voices) {
    // Cache results.
  ...
  Formatter.prototype.getMinTotalWidth = function getMinTotalWidth() {
  ...
  Formatter.prototype.createModifierContexts = function createModifierContexts(voices) {
  ...
  Formatter.prototype.createTickContexts = function createTickContexts(voices) {
  ...
  Formatter.prototype.evaluate = function evaluate() {
    var _this2 = this;
  ...
  Formatter.prototype.postFormat = function postFormat() {
  ...
  Formatter.prototype.joinVoices = function joinVoices(voices) {
  ...
  Formatter.prototype.format = function format(voices, justifyWidth, options) {
    var opts = {
      align_rests: false,
      context: null,
      stave: null
  ...
  Formatter.prototype.formatToStave = function formatToStave(voices, stave, options) {
...
var Voice = exports.Voice = function (_Element) {
  ...
  Voice.prototype.getTotalTicks = function getTotalTicks() {
  ...
  Voice.prototype.getTicksUsed = function getTicksUsed() {
  ...
  Voice.prototype.getLargestTickWidth = function getLargestTickWidth() {
  ...
  Voice.prototype.getSmallestTickCount = function getSmallestTickCount() {
  ...
  Voice.prototype.getTickables = function getTickables() {
  ...
  Voice.prototype.getMode = function getMode() {
    return this.mode;
  };

  Voice.prototype.setMode = function setMode(mode) {
  ...
  Voice.prototype.getResolutionMultiplier = function getResolutionMultiplier() {
  ...
  Voice.prototype.getActualResolution = function getActualResolution() {
  ...
  Voice.prototype.setStave = function setStave(stave) {
    this.stave = stave;
  ...
  Voice.prototype.getBoundingBox = function getBoundingBox() {
    var stave = void 0;
  ...
  Voice.prototype.getVoiceGroup = function getVoiceGroup() {
    if (!this.voiceGroup) {
  ...
  Voice.prototype.setVoiceGroup = function setVoiceGroup(g) {
  ...
  Voice.prototype.setStrict = function setStrict(strict) {
  ...
  Voice.prototype.isComplete = function isComplete() {
  ...
  Voice.prototype.addTickable = function addTickable(tickable) {
  ...
  Voice.prototype.addTickables = function addTickables(tickables) {
  ...
  Voice.prototype.preFormat = function preFormat() {
    var _this2 = this;
  ...
  Voice.prototype.draw = function draw() {
    var context = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.context;
...
var TickContext = exports.TickContext = function (_Tickable) {
  ...
  TickContext.prototype.setX = function setX(x) {
    this.x = x;this.xBase = x;this.xOffset = 0;return this;
  };

  TickContext.prototype.getXBase = function getXBase() {
    return this.xBase;
  }; // use of xBase and xOffset is optional, avoids offset creep


  TickContext.prototype.setXBase = function setXBase(xBase) {
    this.xBase = xBase;this.x = xBase + this.xOffset;
  };

  TickContext.prototype.getXOffset = function getXOffset() {
    return this.xOffset;
  };

  TickContext.prototype.setXOffset = function setXOffset(xOffset) {
  ...
  TickContext.prototype.getMaxTicks = function getMaxTicks() {
    return this.maxTicks;
  };

  TickContext.prototype.getMinTicks = function getMinTicks() {
  ...
  TickContext.prototype.getMetrics = function getMetrics() {
  ...
  TickContext.prototype.getCurrentTick = function getCurrentTick() {
    return this.currentTick;
  };

  TickContext.prototype.setCurrentTick = function setCurrentTick(tick) {
  ...
  TickContext.prototype.getExtraPx = function getExtraPx() {
    var left_shift = 0;
    var right_shift = 0;
    var extraLeftPx = 0;
    var extraRightPx = 0;
  ...
  TickContext.prototype.addTickable = function addTickable(tickable) {
    if (!tickable) {
  ...
  TickContext.prototype.preFormat = function preFormat() {
    if (this.preFormatted) return this;
  ...
  TickContext.prototype.postFormat = function postFormat() {
...
var Renderer = exports.Renderer = function () {
  Renderer.buildContext = function buildContext(elementId, backend, width, height, background) {
  ...
  Renderer.getCanvasContext = function getCanvasContext(elementId, width, height, background) {
    return Renderer.buildContext(elementId, Renderer.Backends.CANVAS, width, height, background);
  };

  Renderer.getRaphaelContext = function getRaphaelContext(elementId, width, height, background) {
    return Renderer.buildContext(elementId, Renderer.Backends.RAPHAEL, width, height, background);
  };

  Renderer.getSVGContext = function getSVGContext(elementId, width, height, background) {
    return Renderer.buildContext(elementId, Renderer.Backends.SVG, width, height, background);
  };

  Renderer.bolsterCanvasContext = function bolsterCanvasContext(ctx) {
  ...
  Renderer.drawDashedLine = function drawDashedLine(context, fromX, fromY, toX, toY, dashPattern) {
    context.beginPath();
...
var Beam = exports.Beam = function (_Element) {
  ...
  Beam.getDefaultBeamGroups = function getDefaultBeamGroups(time_sig) {
  ...
  Beam.applyAndGetBeams = function applyAndGetBeams(voice, stem_direction, groups) {
  ...
  Beam.generateBeams = function generateBeams(notes, config) {
    if (!config) config = {};
  ...
  Beam.prototype.getNotes = function getNotes() {
    return this.notes;
  };
  ...
  Beam.prototype.getBeamCount = function getBeamCount() {
  ...
  Beam.prototype.breakSecondaryAt = function breakSecondaryAt(indices) {
  ...
  Beam.prototype.getSlopeY = function getSlopeY(x, first_x_px, first_y_px, slope) {
  ...
  Beam.prototype.calculateSlope = function calculateSlope() {
  ...
  Beam.prototype.calculateFlatSlope = function calculateFlatSlope() {
    var notes = this.notes,
  ...
  Beam.prototype.applyStemExtensions = function applyStemExtensions() {
    var notes = this.notes,
        slope = this.slope,
  ...
  Beam.prototype.getBeamLines = function getBeamLines(duration) {
    var beam_lines = [];
  ...
  Beam.prototype.drawStems = function drawStems() {
    var _this2 = this;
  ...
  Beam.prototype.drawBeamLines = function drawBeamLines() {
    this.checkContext();
  ...
  Beam.prototype.preFormat = function preFormat() {
    return this;
  };
  ...
  Beam.prototype.postFormat = function postFormat() {
  ...
  Beam.prototype.draw = function draw() {
    this.checkContext();
    this.setRendered();
...
var StaveTie = exports.StaveTie = function (_Element) {
  ...
  StaveTie.prototype.setFont = function setFont(font) {
    this.font = font;return this;
  };

  StaveTie.prototype.setDirection = function setDirection(direction) {
  ...
  StaveTie.prototype.setNotes = function setNotes(notes) {
  ...
  StaveTie.prototype.isPartial = function isPartial() {
    return !this.first_note || !this.last_note;
  };

  StaveTie.prototype.renderTie = function renderTie(params) {
  ...
  StaveTie.prototype.renderText = function renderText(first_x_px, last_x_px) {
    if (!this.text) return;
  ...
  StaveTie.prototype.draw = function draw() {
    this.checkContext();
    this.setRendered();
...
var Articulation = exports.Articulation = function (_Modifier) {
  ...
  Articulation.format = function format(articulations, state) {
  ...
  Articulation.easyScoreHook = function easyScoreHook(_ref, note, builder) {
  ...
  function Articulation(type) {
    ...
    var _this = _possibleConstructorReturn(this, _Modifier.call(this));
  ...
  Articulation.prototype.getCategory = function getCategory() {
  ...
  Articulation.prototype.draw = function draw() {
    ...
    var y = (_ABOVE$BELOW$position = {}, _ABOVE$BELOW$position[ABOVE] = function () {
      glyph.setOrigin(0.5, 1);
      var y = getTopY(note, textLine) - (textLine + initialOffset) * staffSpace;
      return shouldSitOutsideStaff ? Math.min(stave.getYForTopText(Articulation.INITIAL_OFFSET), y) : y;
    }, _ABOVE$BELOW$position[BELOW] = function () {
...
var Tuplet = exports.Tuplet = function (_Element) {
  ...
  Tuplet.prototype.attach = function attach() {
  ...
  Tuplet.prototype.detach = function detach() {
    for (var i = 0; i < this.notes.length; i++) {
      var note = this.notes[i];
  ...
  Tuplet.prototype.setBracketed = function setBracketed(bracketed) {
  ...
  Tuplet.prototype.setRatioed = function setRatioed(ratioed) {
  ...
  Tuplet.prototype.setTupletLocation = function setTupletLocation(location) {
    if (!location) {
  ...
  Tuplet.prototype.getNotes = function getNotes() {
    return this.notes;
  };

  Tuplet.prototype.getNoteCount = function getNoteCount() {
    return this.num_notes;
  };

  Tuplet.prototype.beatsOccupiedDeprecationWarning = function beatsOccupiedDeprecationWarning() {
  ...
  Tuplet.prototype.getBeatsOccupied = function getBeatsOccupied() {
    this.beatsOccupiedDeprecationWarning();
    return this.getNotesOccupied();
  };

  Tuplet.prototype.setBeatsOccupied = function setBeatsOccupied(beats) {
    this.beatsOccupiedDeprecationWarning();
    return this.setNotesOccupied(beats);
  };

  Tuplet.prototype.getNotesOccupied = function getNotesOccupied() {
    return this.notes_occupied;
  };

  Tuplet.prototype.setNotesOccupied = function setNotesOccupied(notes) {
    this.detach();
  ...
  Tuplet.prototype.resolveGlyphs = function resolveGlyphs() {
    this.num_glyphs = [];
  ...
  Tuplet.prototype.getNestedTupletCount = function getNestedTupletCount() {
  ...
  Tuplet.prototype.getYPosition = function getYPosition() {
  ...
  Tuplet.prototype.draw = function draw() {
    var _this2 = this;
...
var StaveConnector = exports.StaveConnector = function (_Element) {
  ...
  StaveConnector.prototype.setType = function setType(type) {
  ...
  StaveConnector.prototype.setText = function setText(text, options) {
    this.texts.push({
      content: text,
  ...
  StaveConnector.prototype.setFont = function setFont(font) {
    _vex.Vex.Merge(this.font, font);
  };

  StaveConnector.prototype.setXShift = function setXShift(x_shift) {
  ...
  StaveConnector.prototype.draw = function draw() {
    var ctx = this.checkContext();
    this.setRendered();
...
var StemmableNote = exports.StemmableNote = function (_Note) {
  ...
  function StemmableNote(note_struct) {
    ...
    var _this = _possibleConstructorReturn(this, _Note.call(this, note_struct));
  ...
  StemmableNote.prototype.getStem = function getStem() {
    return this.stem;
  };

  StemmableNote.prototype.setStem = function setStem(stem) {
  ...
  StemmableNote.prototype.buildStem = function buildStem() {
    var stem = new _stem.Stem();
    this.setStem(stem);
    return this;
  };

  StemmableNote.prototype.buildFlag = function buildFlag() {
  ...
  StemmableNote.prototype.getStemLength = function getStemLength() {
  ...
  StemmableNote.prototype.getBeamCount = function getBeamCount() {
    var glyph = this.getGlyph();
  ...
  StemmableNote.prototype.getStemMinumumLength = function getStemMinumumLength() {
    var frac = _tables.Flow.durationToFraction(this.duration);
  ...
  StemmableNote.prototype.getStemDirection = function getStemDirection() {
    return this.stem_direction;
  };

  StemmableNote.prototype.setStemDirection = function setStemDirection(direction) {
  ...
  StemmableNote.prototype.getStemX = function getStemX() {
  ...
  StemmableNote.prototype.getCenterGlyphX = function getCenterGlyphX() {
  ...
  StemmableNote.prototype.getStemExtension = function getStemExtension() {
    var glyph = this.getGlyph();
  ...
  StemmableNote.prototype.setStemLength = function setStemLength(height) {
  ...
  StemmableNote.prototype.getStemExtents = function getStemExtents() {
  ...
  StemmableNote.prototype.setBeam = function setBeam(beam) {
  ...
  StemmableNote.prototype.getYForTopText = function getYForTopText(textLine) {
    var extents = this.getStemExtents();
    if (this.hasStem()) {
      return Math.min(this.stave.getYForTopText(textLine), extents.topY - this.render_options.annotation_spacing * (textLine + 1));
    } else {
  ...
  StemmableNote.prototype.getYForBottomText = function getYForBottomText(textLine) {
    var extents = this.getStemExtents();
    if (this.hasStem()) {
      return Math.max(this.stave.getYForTopText(textLine), extents.baseY + this.render_options.annotation_spacing * textLine);
    } else {
  ...
  StemmableNote.prototype.hasFlag = function hasFlag() {
  ...
  StemmableNote.prototype.postFormat = function postFormat() {
  ...
  StemmableNote.prototype.drawStem = function drawStem(stem_struct) {
    this.checkContext();
    this.setRendered();
...
var Dot = exports.Dot = function (_Modifier) {
  ...
  Dot.format = function format(dots, state) {
  ...
  Dot.prototype.getCategory = function getCategory() {
    return Dot.CATEGORY;
  };

  Dot.prototype.setNote = function setNote(note) {
    this.note = note;
  ...
  Dot.prototype.setDotShiftY = function setDotShiftY(y) {
...
var ModifierContext = exports.ModifierContext = function () {
  ...
  ModifierContext.prototype.addModifier = function addModifier(modifier) {
  ...
  ModifierContext.prototype.getModifiers = function getModifiers(type) {
    return this.modifiers[type];
  };

  ModifierContext.prototype.getWidth = function getWidth() {
    return this.width;
  };

  ModifierContext.prototype.getExtraLeftPx = function getExtraLeftPx() {
    return this.state.left_shift;
  };

  ModifierContext.prototype.getExtraRightPx = function getExtraRightPx() {
    return this.state.right_shift;
  };

  ModifierContext.prototype.getState = function getState() {
    return this.state;
  };

  ModifierContext.prototype.getMetrics = function getMetrics() {
    if (!this.formatted) {
  ...
  ModifierContext.prototype.preFormat = function preFormat() {
    var _this = this;
  ...
  ModifierContext.prototype.postFormat = function postFormat() {
    var _this2 = this;
...
var FretHandFinger = exports.FretHandFinger = function (_Modifier) {
  ...
  FretHandFinger.format = function format(nums, state) {
  ...
  FretHandFinger.prototype.getCategory = function getCategory() {
    return FretHandFinger.CATEGORY;
  };

  FretHandFinger.prototype.setFretHandFinger = function setFretHandFinger(number) {
    this.finger = number;return this;
  };

  FretHandFinger.prototype.setOffsetX = function setOffsetX(x) {
    this.x_offset = x;return this;
  };

  FretHandFinger.prototype.setOffsetY = function setOffsetY(y) {
    this.y_offset = y;return this;
  };

  FretHandFinger.prototype.draw = function draw() {
    this.checkContext();
...
var Accidental = exports.Accidental = function (_Modifier) {
  ...
  Accidental.format = function format(accidentals, state) {
    var _this2 = this;
    ...
    var _loop = function _loop(_i3) {
      ...
      var lineDifference = function lineDifference(indexA, indexB) {
        var _getGroupLines$map = getGroupLines([indexA, indexB]).map(function (item) {
          return item.line;
            ...
            a = _getGroupLines$map[0],
            b = _getGroupLines$map[1];
      ...
      var notColliding = function notColliding() {
        ...
        return indexPairs.map(getGroupLines).every(function (lines) {
          return !_this2.checkCollision.apply(_this2, lines);
        });
      };
  ...
  Accidental.checkCollision = function checkCollision(line1, line2) {
  ...
  Accidental.applyAccidentals = function applyAccidentals(voices, keySignature) {
    var tickPositions = [];
    var tickNoteMap = {};
  ...
  Accidental.prototype.reset = function reset() {
  ...
  Accidental.prototype.getCategory = function getCategory() {
    return Accidental.CATEGORY;
  };

  Accidental.prototype.getWidth = function getWidth() {
  ...
  Accidental.prototype.setNote = function setNote(note) {
    if (!note) {
  ...
  Accidental.prototype.setAsCautionary = function setAsCautionary() {
  ...
  Accidental.prototype.draw = function draw() {
...
var Music = exports.Music = function () {
  ...
  Music.prototype.isValidNoteValue = function isValidNoteValue(note) {
  ...
  Music.prototype.isValidIntervalValue = function isValidIntervalValue(interval) {
    return this.isValidNoteValue(interval);
  };

  Music.prototype.getNoteParts = function getNoteParts(noteString) {
  ...
  Music.prototype.getKeyParts = function getKeyParts(keyString) {
  ...
  Music.prototype.getNoteValue = function getNoteValue(noteString) {
  ...
  Music.prototype.getIntervalValue = function getIntervalValue(intervalString) {
  ...
  Music.prototype.getCanonicalNoteName = function getCanonicalNoteName(noteValue) {
  ...
  Music.prototype.getCanonicalIntervalName = function getCanonicalIntervalName(intervalValue) {
  ...
  Music.prototype.getRelativeNoteValue = function getRelativeNoteValue(noteValue, intervalValue, direction) {
  ...
  Music.prototype.getRelativeNoteName = function getRelativeNoteName(root, noteValue) {
  ...
  Music.prototype.getScaleTones = function getScaleTones(key, intervals) {
    var tones = [key];
  ...
  Music.prototype.getIntervalBetween = function getIntervalBetween(note1, note2, direction) {
    if (direction == null) direction = 1;
  ...
  Music.prototype.createScaleMap = function createScaleMap(keySignature) {
...
var NoteSubGroup = exports.NoteSubGroup = function (_Modifier) {
  ...
  NoteSubGroup.format = function format(groups, state) {
  ...
  NoteSubGroup.prototype.getCategory = function getCategory() {
    return NoteSubGroup.CATEGORY;
  };

  NoteSubGroup.prototype.preFormat = function preFormat() {
    if (this.preFormatted) return;
  ...
  NoteSubGroup.prototype.setNote = function setNote(note) {
    this.note = note;
  };

  NoteSubGroup.prototype.setWidth = function setWidth(width) {
    this.width = width;
  };

  NoteSubGroup.prototype.getWidth = function getWidth() {
    return this.width;
  };

  NoteSubGroup.prototype.draw = function draw() {
    var _this2 = this;
...
var GraceNoteGroup = exports.GraceNoteGroup = function (_Modifier) {
  ...
  // Arrange groups inside a `ModifierContext`
  GraceNoteGroup.format = function format(gracenote_groups, state) {
  ...
  GraceNoteGroup.prototype.getCategory = function getCategory() {
    return GraceNoteGroup.CATEGORY;
  };

  GraceNoteGroup.prototype.preFormat = function preFormat() {
    if (this.preFormatted) return;
  ...
  GraceNoteGroup.prototype.setNote = function setNote(note) {
    this.note = note;
  };

  GraceNoteGroup.prototype.setWidth = function setWidth(width) {
    this.width = width;
  };

  GraceNoteGroup.prototype.getWidth = function getWidth() {
    return this.width;
  };

  GraceNoteGroup.prototype.getGraceNotes = function getGraceNotes() {
    return this.grace_notes;
  };

  GraceNoteGroup.prototype.draw = function draw() {
    var _this2 = this;
...
var TabTie = exports.TabTie = function (_StaveTie) {
  ...
  TabTie.createHammeron = function createHammeron(notes) {
    return new TabTie(notes, 'H');
  };

  TabTie.createPulloff = function createPulloff(notes) {
  ...
  function TabTie(notes, text) {
    ...
    var _this = _possibleConstructorReturn(this, _StaveTie.call(this, notes, text));
    /**
     * Notes is a struct that has:
     *
     *  {
  ...
  TabTie.prototype.draw = function draw() {
    this.checkContext();
    this.setRendered();
...
var StringNumber = exports.StringNumber = function (_Modifier) {
  ...
  StringNumber.format = function format(nums, state) {
    var left_shift = state.left_shift;
    var right_shift = state.right_shift;
    var num_spacing = 1;
  ...
  StringNumber.prototype.getCategory = function getCategory() {
    return StringNumber.CATEGORY;
  };

  StringNumber.prototype.getNote = function getNote() {
    return this.note;
  };

  StringNumber.prototype.setNote = function setNote(note) {
    this.note = note;return this;
  };

  StringNumber.prototype.getIndex = function getIndex() {
    return this.index;
  };

  StringNumber.prototype.setIndex = function setIndex(index) {
    this.index = index;return this;
  };

  StringNumber.prototype.setLineEndType = function setLineEndType(leg) {
  ...
  StringNumber.prototype.setStringNumber = function setStringNumber(number) {
    this.string_number = number;return this;
  };

  StringNumber.prototype.setOffsetX = function setOffsetX(x) {
    this.x_offset = x;return this;
  };

  StringNumber.prototype.setOffsetY = function setOffsetY(y) {
    this.y_offset = y;return this;
  };

  StringNumber.prototype.setLastNote = function setLastNote(note) {
    this.last_note = note;return this;
  };

  StringNumber.prototype.setDashed = function setDashed(dashed) {
    this.dashed = dashed;return this;
  };

  StringNumber.prototype.draw = function draw() {
    var ctx = this.checkContext();
    if (!(this.note && this.index != null)) {
      throw new _vex.Vex.RERR('NoAttachedNote', "Can't draw string number without a note and index.");
    }
...
var Annotation = exports.Annotation = function (_Modifier) {
  ...
  Annotation.format = function format(annotations, state) {
  ...
  Annotation.prototype.getCategory = function getCategory() {
  ...
  Annotation.prototype.setFont = function setFont(family, size, weight) {
  ...
  Annotation.prototype.setVerticalJustification = function setVerticalJustification(just) {
  ...
  Annotation.prototype.getJustification = function getJustification() {
    return this.justification;
  };

  Annotation.prototype.setJustification = function setJustification(just) {
...
var Bend = exports.Bend = function (_Modifier) {
  ...
  Bend.format = function format(bends, state) {
  ...
  Bend.prototype.getCategory = function getCategory() {
    return Bend.CATEGORY;
  };

  Bend.prototype.setXShift = function setXShift(value) {
    this.x_shift = value;
    this.updateWidth();
  };

  Bend.prototype.setFont = function setFont(font) {
    this.font = font;return this;
  };

  Bend.prototype.getText = function getText() {
    return this.text;
  };

  Bend.prototype.updateWidth = function updateWidth() {
    var that = this;
  ...
  Bend.prototype.draw = function draw() {
    this.checkContext();
    if (!(this.note && this.index != null)) {
...
var Vibrato = exports.Vibrato = function (_Modifier) {
  ...
  Vibrato.format = function format(vibratos, state, context) {
  ...
  Vibrato.prototype.getCategory = function getCategory() {
...
var Stave = exports.Stave = function (_Element) {
  ...
  Stave.prototype.space = function space(spacing) {
  ...
  Stave.prototype.getOptions = function getOptions() {
    return this.options;
  };

  Stave.prototype.setNoteStartX = function setNoteStartX(x) {
  ...
  Stave.prototype.getNoteStartX = function getNoteStartX() {
    if (!this.formatted) this.format();

    return this.start_x;
  };

  Stave.prototype.getNoteEndX = function getNoteEndX() {
    if (!this.formatted) this.format();

    return this.end_x;
  };

  Stave.prototype.getTieStartX = function getTieStartX() {
    return this.start_x;
  };
  ...
  Stave.prototype.getNumLines = function getNumLines() {
    return this.options.num_lines;
  };

  Stave.prototype.setNumLines = function setNumLines(lines) {
    this.options.num_lines = parseInt(lines, 10);
    this.resetLines();
    return this;
  };

  Stave.prototype.setY = function setY(y) {
    this.y = y;return this;
  };

  Stave.prototype.getTopLineTopY = function getTopLineTopY() {
    return this.getYForLine(0) - _tables.Flow.STAVE_LINE_THICKNESS / 2;
  };

  Stave.prototype.getBottomLineBottomY = function getBottomLineBottomY() {
    return this.getYForLine(this.getNumLines() - 1) + _tables.Flow.STAVE_LINE_THICKNESS / 2;
  };

  Stave.prototype.setX = function setX(x) {
    var shift = x - this.x;
  ...
  Stave.prototype.setWidth = function setWidth(width) {
    this.formatted = false;
    this.width = width;
  ...
  Stave.prototype.getWidth = function getWidth() {
    return this.width;
  };

  Stave.prototype.getStyle = function getStyle() {
    return _extends({
  ...
  Stave.prototype.setMeasure = function setMeasure(measure) {
  ...
  Stave.prototype.getModifierXShift = function getModifierXShift() {
  ...
  Stave.prototype.setRepetitionTypeLeft = function setRepetitionTypeLeft(type, y) {
    this.modifiers.push(new _staverepetition.Repetition(type, this.x, y));
    return this;
  };

  Stave.prototype.setRepetitionTypeRight = function setRepetitionTypeRight(type, y) {
    this.modifiers.push(new _staverepetition.Repetition(type, this.x, y));
    return this;
  };
  ...
  Stave.prototype.setVoltaType = function setVoltaType(type, number_t, y) {
  ...
  Stave.prototype.setSection = function setSection(section, y) {
  ...
  Stave.prototype.setTempo = function setTempo(tempo, y) {
  ...
  Stave.prototype.setText = function setText(text, position, options) {
    this.modifiers.push(new _stavetext.StaveText(text, position, options));
    return this;
  };

  Stave.prototype.getHeight = function getHeight() {
    return this.height;
  };

  Stave.prototype.getSpacingBetweenLines = function getSpacingBetweenLines() {
    return this.options.spacing_between_lines_px;
  };

  Stave.prototype.getBoundingBox = function getBoundingBox() {
    return new _boundingbox.BoundingBox(this.x, this.y, this.width, this.getBottomY() - this.y);
  };

  Stave.prototype.getBottomY = function getBottomY() {
  ...
  Stave.prototype.getBottomLineY = function getBottomLineY() {
  ...
  Stave.prototype.getYForLine = function getYForLine(line) {
    var options = this.options;
    var spacing = options.spacing_between_lines_px;
  ...
  Stave.prototype.getLineForY = function getLineForY(y) {
  ...
  Stave.prototype.getYForTopText = function getYForTopText(line) {
    var l = line || 0;
    return this.getYForLine(-l - this.options.top_text_position);
  };

  Stave.prototype.getYForBottomText = function getYForBottomText(line) {
    var l = line || 0;
    return this.getYForLine(this.options.bottom_text_position + l);
  };

  Stave.prototype.getYForNote = function getYForNote(line) {
    var options = this.options;
    var spacing = options.spacing_between_lines_px;
    var headroom = options.space_above_staff_ln;
  ...
  Stave.prototype.getYForGlyphs = function getYForGlyphs() {
    return this.getYForLine(3);
  };

  Stave.prototype.addModifier = function addModifier(modifier, position) {
  ...
  Stave.prototype.addEndModifier = function addEndModifier(modifier) {
  ...
  Stave.prototype.setBegBarType = function setBegBarType(type) {
  ...
  Stave.prototype.setEndBarType = function setEndBarType(type) {
  ...
  Stave.prototype.setClef = function setClef(clefSpec, size, annotation, position) {
    if (position === undefined) {
  ...
  Stave.prototype.setEndClef = function setEndClef(clefSpec, size, annotation) {
  ...
  Stave.prototype.setTimeSignature = function setTimeSignature(timeSpec, customPadding, position) {
    if (position === undefined) {
      position = _stavemodifier.StaveModifier.Position.BEGIN;
    }
  ...
  Stave.prototype.setEndTimeSignature = function setEndTimeSignature(timeSpec, customPadding) {
  ...
  Stave.prototype.addClef = function addClef(clef, size, annotation, position) {
  ...
  Stave.prototype.addEndClef = function addEndClef(clef, size, annotation) {
    this.addClef(clef, size, annotation, _stavemodifier.StaveModifier.Position.END);
    return this;
  };

  Stave.prototype.addTimeSignature = function addTimeSignature(timeSpec, customPadding, position) {
    this.addModifier(new _timesignature.TimeSignature(timeSpec, customPadding), position);
    return this;
  };

  Stave.prototype.addEndTimeSignature = function addEndTimeSignature(timeSpec, customPadding) {
  ...
  Stave.prototype.addTrebleGlyph = function addTrebleGlyph() {
    this.addClef('treble');
    return this;
  };

  Stave.prototype.getModifiers = function getModifiers(position, category) {
  ...
  Stave.prototype.sortByCategory = function sortByCategory(items, order) {
  ...
  Stave.prototype.format = function format() {
    var begBarline = this.modifiers[0];
  ...
  Stave.prototype.drawVertical = function drawVertical(x, isDouble) {
  ...
  Stave.prototype.drawVerticalBar = function drawVerticalBar(x) {
  ...
  Stave.prototype.getConfigForLines = function getConfigForLines() {
  ...
  Stave.prototype.setConfigForLine = function setConfigForLine(line_number, line_config) {
  ...
  Stave.prototype.setConfigForLines = function setConfigForLines(lines_configuration) {
...
var Barline = exports.Barline = function (_StaveModifier) {
  ...
  function Barline(type) {
    ...
    var _this = _possibleConstructorReturn(this, _StaveModifier.call(this));
  ...
  Barline.prototype.getCategory = function getCategory() {
    return Barline.CATEGORY;
  };

  Barline.prototype.getType = function getType() {
    return this.type;
  };

  Barline.prototype.setType = function setType(type) {
  ...
  Barline.prototype.draw = function draw(stave) {
    stave.checkContext();
    this.setRendered();
  ...
  Barline.prototype.drawVerticalBar = function drawVerticalBar(stave, x, double_bar) {
    stave.checkContext();
  ...
  Barline.prototype.drawVerticalEndBar = function drawVerticalEndBar(stave, x) {
    stave.checkContext();
    var topY = stave.getTopLineTopY();
    var botY = stave.getBottomLineBottomY();
  ...
  Barline.prototype.drawRepeatBar = function drawRepeatBar(stave, x, begin) {
    stave.checkContext();
...
var TextNote = exports.TextNote = function (_Note) {
  ...
  function TextNote(text_struct) {
    ...
    var _this = _possibleConstructorReturn(this, _Note.call(this, text_struct));
  ...
  TextNote.prototype.setJustification = function setJustification(just) {
  ...
  TextNote.prototype.setLine = function setLine(line) {
    this.line = line;
    return this;
  };
  ...
  TextNote.prototype.preFormat = function preFormat() {
    this.checkContext();
  ...
  TextNote.prototype.draw = function draw() {
    this.checkContext();
...
var Clef = exports.Clef = function (_StaveModifier) {
  ...
  Clef.prototype.getCategory = function getCategory() {
    return Clef.CATEGORY;
  };

  Clef.prototype.setType = function setType(type, size, annotation) {
    this.type = type;
  ...
  Clef.prototype.getWidth = function getWidth() {
  ...
  Clef.prototype.setStave = function setStave(stave) {
    this.stave = stave;
  ...
  Clef.prototype.draw = function draw() {
...
var TimeSignature = exports.TimeSignature = function (_StaveModifier) {
  ...
  TimeSignature.prototype.getCategory = function getCategory() {
    return TimeSignature.CATEGORY;
  };

  TimeSignature.prototype.parseTimeSpec = function parseTimeSpec(timeSpec) {
    ...
    var _timeSpec$split$map = timeSpec.split('/').map(function (number) {
      return number.split('');
        ...
        topDigits = _timeSpec$split$map[0],
        botDigits = _timeSpec$split$map[1];
  ...
  TimeSignature.prototype.makeTimeSignatureGlyph = function makeTimeSignatureGlyph(topDigits, botDigits) {
  ...
  TimeSignature.prototype.getTimeSig = function getTimeSig() {
    return this.timeSig;
  };

  TimeSignature.prototype.setTimeSig = function setTimeSig(timeSpec) {
    this.timeSig = this.parseTimeSpec(timeSpec);
    return this;
  };

  TimeSignature.prototype.draw = function draw() {
    if (!this.x) {
...
var TabNote = exports.TabNote = function (_StemmableNote) {
  ...
  function TabNote(tab_struct, draw_stem) {
    ...
    var _this = _possibleConstructorReturn(this, _StemmableNote.call(this, tab_struct));
  ...
  TabNote.prototype.reset = function reset() {
  ...
  TabNote.prototype.getCategory = function getCategory() {
  ...
  TabNote.prototype.setGhost = function setGhost(ghost) {
    this.ghost = ghost;
    this.updateWidth();
    return this;
  };
  ...
  TabNote.prototype.hasStem = function hasStem() {
  ...
  TabNote.prototype.getStemExtension = function getStemExtension() {
    var glyph = this.getGlyph();
  ...
  TabNote.prototype.addDot = function addDot() {
    var dot = new _dot.Dot();
    this.dots += 1;
  ...
  TabNote.prototype.updateWidth = function updateWidth() {
    var _this2 = this;
  ...
  TabNote.prototype.setStave = function setStave(stave) {
    var _this3 = this;
  ...
  TabNote.prototype.getPositions = function getPositions() {
  ...
  TabNote.prototype.addToModifierContext = function addToModifierContext(mc) {
  ...
  TabNote.prototype.getTieRightX = function getTieRightX() {
    var tieStartX = this.getAbsoluteX();
  ...
  TabNote.prototype.getTieLeftX = function getTieLeftX() {
    var tieEndX = this.getAbsoluteX();
    var note_glyph_width = this.glyph.getWidth();
  ...
  TabNote.prototype.getModifierStartXY = function getModifierStartXY(position, index) {
    if (!this.preFormatted) {
      throw new _vex.Vex.RERR('UnformattedNote', "Can't call GetModifierStartXY on an unformatted note");
    }
  ...
  TabNote.prototype.getLineForRest = function getLineForRest() {
  ...
  TabNote.prototype.preFormat = function preFormat() {
    if (this.preFormatted) return;
    if (this.modifierContext) this.modifierContext.preFormat();
  ...
  TabNote.prototype.getStemX = function getStemX() {
    return this.getCenterGlyphX();
  };
  ...
  TabNote.prototype.getStemY = function getStemY() {
  ...
  TabNote.prototype.getStemExtents = function getStemExtents() {
    return this.stem.getExtents();
  };
  ...
  TabNote.prototype.drawFlag = function drawFlag() {
    var beam = this.beam,
        glyph = this.glyph,
  ...
  TabNote.prototype.drawModifiers = function drawModifiers() {
    var _this4 = this;
  ...
  TabNote.prototype.drawStemThrough = function drawStemThrough() {
  ...
  TabNote.prototype.drawPositions = function drawPositions() {
    var ctx = this.context;
    var x = this.getAbsoluteX();
    var ys = this.ys;
    for (var i = 0; i < this.positions.length; ++i) {
  ...
  TabNote.prototype.draw = function draw() {
    this.checkContext();
...
var Registry = exports.Registry = function () {
  ...
  Registry.enableDefaultRegistry = function enableDefaultRegistry(registry) {
    Registry.defaultRegistry = registry;
  };

  Registry.getDefaultRegistry = function getDefaultRegistry() {
    return Registry.defaultRegistry;
  };

  Registry.disableDefaultRegistry = function disableDefaultRegistry() {
  ...
  Registry.prototype.updateIndex = function updateIndex(_ref) {
    var id = _ref.id,
        name = _ref.name,
        value = _ref.value,
  ...
  Registry.prototype.register = function register(elem, id) {
    var _this = this;
  ...
  Registry.prototype.getElementById = function getElementById(id) {
    return this.index.id[id] ? this.index.id[id][id] : null;
  };

  Registry.prototype.getElementsByAttribute = function getElementsByAttribute(attrName, value) {
  ...
  Registry.prototype.getElementsByType = function getElementsByType(type) {
    return this.getElementsByAttribute('type', type);
  };

  Registry.prototype.getElementsByClass = function getElementsByClass(className) {
  ...
  Registry.prototype.onUpdate = function onUpdate(_ref2) {
    var id = _ref2.id,
        name = _ref2.name,
        value = _ref2.value,
...
var NoteHead = exports.NoteHead = function (_Note) {
  ...
  function NoteHead(head_options) {
    ...
    var _this = _possibleConstructorReturn(this, _Note.call(this, head_options));
  ...
  NoteHead.prototype.getCategory = function getCategory() {
  ...
  NoteHead.prototype.getWidth = function getWidth() {
    return this.width;
  };
  ...
  NoteHead.prototype.isDisplaced = function isDisplaced() {
  ...
  NoteHead.prototype.getGlyph = function getGlyph() {
    return this.glyph;
  };
  ...
  NoteHead.prototype.setX = function setX(x) {
    this.x = x;return this;
  };
  ...
  NoteHead.prototype.getY = function getY() {
    return this.y;
  };

  NoteHead.prototype.setY = function setY(y) {
    this.y = y;return this;
  };
  ...
  NoteHead.prototype.getLine = function getLine() {
    return this.line;
  };

  NoteHead.prototype.setLine = function setLine(line) {
  ...
  NoteHead.prototype.getAbsoluteX = function getAbsoluteX() {
    // If the note has not been preformatted, then get the static x value
    // Otherwise, it's been formatted and we should use it's x value relative
    // to its tick context
    var x = !this.preFormatted ? this.x : _Note.prototype.getAbsoluteX.call(this);
  ...
  NoteHead.prototype.getBoundingBox = function getBoundingBox() {
    if (!this.preFormatted) {
      throw new _vex.Vex.RERR('UnformattedNote', "Can't call getBoundingBox on an unformatted note.");
    }
  ...
  NoteHead.prototype.setStave = function setStave(stave) {
  ...
  NoteHead.prototype.preFormat = function preFormat() {
    if (this.preFormatted) return this;
  ...
  NoteHead.prototype.draw = function draw() {
    this.checkContext();
    this.setRendered();
...
var Tickable = exports.Tickable = function (_Element) {
  ...
  Tickable.prototype.reset = function reset() {
    return this;
  };
  ...
  Tickable.prototype.shouldIgnoreTicks = function shouldIgnoreTicks() {
    return this.ignore_ticks;
  };
  ...
  Tickable.prototype.setXShift = function setXShift(x) {
    this.x_shift = x;
  };

  Tickable.prototype.getCenterXShift = function getCenterXShift() {
    if (this.isCenterAligned()) {
  ...
  Tickable.prototype.isCenterAligned = function isCenterAligned() {
    return this.align_center;
  };

  Tickable.prototype.setCenterAlignment = function setCenterAlignment(align_center) {
  ...
  Tickable.prototype.getVoice = function getVoice() {
    if (!this.voice) throw new _vex.Vex.RERR('NoVoice', 'Tickable has no voice.');
    return this.voice;
  };

  Tickable.prototype.setVoice = function setVoice(voice) {
    this.voice = voice;
  };

  Tickable.prototype.getTuplet = function getTuplet() {
    return this.tuplet;
  };
  ...
  Tickable.prototype.resetTuplet = function resetTuplet(tuplet) {
  ...
  Tickable.prototype.setTuplet = function setTuplet(tuplet) {
  ...
  Tickable.prototype.addToModifierContext = function addToModifierContext(mc) {
  ...
  Tickable.prototype.addModifier = function addModifier(mod) {
    this.modifiers.push(mod);
    this.preFormatted = false;
    return this;
  };

  Tickable.prototype.getModifiers = function getModifiers() {
    return this.modifiers;
  };

  Tickable.prototype.setTickContext = function setTickContext(tc) {
    this.tickContext = tc;
    this.preFormatted = false;
  };

  Tickable.prototype.preFormat = function preFormat() {
    if (this.preFormatted) return;
  ...
  Tickable.prototype.postFormat = function postFormat() {
    if (this.postFormatted) return this;
    this.postFormatted = true;
    return this;
  };

  Tickable.prototype.getIntrinsicTicks = function getIntrinsicTicks() {
    return this.intrinsicTicks;
  };

  Tickable.prototype.setIntrinsicTicks = function setIntrinsicTicks(intrinsicTicks) {
    this.intrinsicTicks = intrinsicTicks;
    this.ticks = this.tickMultiplier.clone().multiply(this.intrinsicTicks);
  };

  Tickable.prototype.getTickMultiplier = function getTickMultiplier() {
    return this.tickMultiplier;
  };

  Tickable.prototype.applyTickMultiplier = function applyTickMultiplier(numerator, denominator) {
    this.tickMultiplier.multiply(numerator, denominator);
    this.ticks = this.tickMultiplier.clone().multiply(this.intrinsicTicks);
  };

  Tickable.prototype.setDuration = function setDuration(duration) {
...
var Stroke = exports.Stroke = function (_Modifier) {
  ...
  Stroke.format = function format(strokes, state) {
    var left_shift = state.left_shift;
  ...
  Stroke.prototype.getCategory = function getCategory() {
    return Stroke.CATEGORY;
  };

  Stroke.prototype.getPosition = function getPosition() {
    return this.position;
  };

  Stroke.prototype.addEndNote = function addEndNote(note) {
    this.note_end = note;return this;
  };

  Stroke.prototype.draw = function draw() {
    this.checkContext();
    this.setRendered();
...
var Ornament = exports.Ornament = function (_Modifier) {
  ...
  Ornament.format = function format(ornaments, state) {
  ...
  Ornament.prototype.getCategory = function getCategory() {
  ...
  Ornament.prototype.setDelayed = function setDelayed(delayed) {
  ...
  Ornament.prototype.setUpperAccidental = function setUpperAccidental(accid) {
  ...
  Ornament.prototype.setLowerAccidental = function setLowerAccidental(accid) {
    var scale = this.render_options.font_scale / 1.3;
  ...
  Ornament.prototype.draw = function draw() {
    this.checkContext();
...
var Repetition = exports.Repetition = function (_StaveModifier) {
  ...
  Repetition.prototype.getCategory = function getCategory() {
    return Repetition.CATEGORY;
  };

  Repetition.prototype.setShiftX = function setShiftX(x) {
    this.x_shift = x;return this;
  };

  Repetition.prototype.setShiftY = function setShiftY(y) {
    this.y_shift = y;return this;
  };

  Repetition.prototype.draw = function draw(stave, x) {
    this.setRendered();
  ...
  Repetition.prototype.drawCodaFixed = function drawCodaFixed(stave, x) {
  ...
  Repetition.prototype.drawSignoFixed = function drawSignoFixed(stave, x) {
    var y = stave.getYForTopText(stave.options.num_lines) + this.y_shift;
    _glyph.Glyph.renderGlyph(stave.context, this.x + x + this.x_shift, y + 25, 30, 'v8c', true);
    return this;
  };

  Repetition.prototype.drawSymbolText = function drawSymbolText(stave, x, text, draw_coda) {
...
var KeySignature = exports.KeySignature = function (_StaveModifier) {
  ...
  KeySignature.prototype.getCategory = function getCategory() {
  ...
  KeySignature.prototype.convertToGlyph = function convertToGlyph(acc, nextAcc) {
  ...
  KeySignature.prototype.cancelKey = function cancelKey(spec) {
    this.formatted = false;
  ...
  KeySignature.prototype.convertToCancelAccList = function convertToCancelAccList(spec) {
  ...
  KeySignature.prototype.addToStave = function addToStave(stave) {
  ...
  KeySignature.prototype.convertAccLines = function convertAccLines(clef, type) {
  ...
  KeySignature.prototype.getPadding = function getPadding(index) {
    if (!this.formatted) this.format();

    return this.glyphs.length === 0 || !this.paddingForced && index < 2 ? 0 : this.padding;
  };

  KeySignature.prototype.getWidth = function getWidth() {
    if (!this.formatted) this.format();

    return this.width;
  };

  KeySignature.prototype.setKeySig = function setKeySig(keySpec, cancelKeySpec, alterKeySpec) {
    this.formatted = false;
  ...
  KeySignature.prototype.alterKey = function alterKey(alterKeySpec) {
    this.formatted = false;
    this.alterKeySpec = alterKeySpec;
  ...
  KeySignature.prototype.convertToAlterAccList = function convertToAlterAccList(alterKeySpec) {
  ...
  KeySignature.prototype.format = function format() {
    if (!this.stave) {
  ...
  KeySignature.prototype.draw = function draw() {
    if (!this.x) {
...
var Volta = exports.Volta = function (_StaveModifier) {
  ...
  Volta.prototype.getCategory = function getCategory() {
    return Volta.CATEGORY;
  };

  Volta.prototype.setShiftY = function setShiftY(y) {
    this.y_shift = y;return this;
  };

  Volta.prototype.draw = function draw(stave, x) {
    var ctx = stave.checkContext();
    this.setRendered();
...
var TabStave = exports.TabStave = function (_Stave) {
  ...
  function TabStave(x, y, width, options) {
    ...
    var _this = _possibleConstructorReturn(this, _Stave.call(this, x, y, width, tab_options));

    _this.setAttribute('type', 'TabStave');
    return _this;
  }

  TabStave.prototype.getYForGlyphs = function getYForGlyphs() {
  ...
  TabStave.prototype.addTabGlyph = function addTabGlyph() {
    this.addClef('tab');
    return this;
  };
...
var ClefNote = exports.ClefNote = function (_Note) {
  ...
  function ClefNote(type, size, annotation) {
    ...
    var _this = _possibleConstructorReturn(this, _Note.call(this, { duration: 'b' }));
  ...
  ClefNote.prototype.setType = function setType(type, size, annotation) {
    this.type = type;
  ...
  ClefNote.prototype.getClef = function getClef() {
    return this.clef;
  };

  ClefNote.prototype.setContext = function setContext(context) {
  ...
  ClefNote.prototype.getCategory = function getCategory() {
    return ClefNote.CATEGORY;
  };

  ClefNote.prototype.preFormat = function preFormat() {
    this.setPreFormatted(true);
    return this;
  };

  ClefNote.prototype.draw = function draw() {
...
var TimeSigNote = exports.TimeSigNote = function (_Note) {
  ...
  TimeSigNote.prototype.preFormat = function preFormat() {
    this.setPreFormatted(true);
    return this;
  };

  TimeSigNote.prototype.draw = function draw() {
...
var GraceNote = exports.GraceNote = function (_StaveNote) {
  ...
  function GraceNote(note_struct) {
    ...
    var _this = _possibleConstructorReturn(this, _StaveNote.call(this, _extends(note_struct, {
  ...
  GraceNote.prototype.getCategory = function getCategory() {
    return GraceNote.CATEGORY;
  };

  GraceNote.prototype.draw = function draw() {
    _StaveNote.prototype.draw.call(this);
    this.setRendered();
    var ctx = this.context;
...
var Curve = exports.Curve = function (_Element) {
  ...
  Curve.prototype.setNotes = function setNotes(from, to) {
    if (!from && !to) {
  ...
  Curve.prototype.isPartial = function isPartial() {
    return !this.from || !this.to;
  };

  Curve.prototype.renderCurve = function renderCurve(params) {
    var ctx = this.context;
...
var TextDynamics = exports.TextDynamics = function (_Note) {
  ...
  TextDynamics.prototype.setLine = function setLine(line) {
    this.line = line;
    return this;
  };
  ...
  TextDynamics.prototype.preFormat = function preFormat() {
    var _this2 = this;
  ...
  TextDynamics.prototype.draw = function draw() {
    var _this3 = this;
...
var StaveLine = exports.StaveLine = function (_Element) {
  ...
  StaveLine.prototype.setFont = function setFont(font) {
    this.font = font;return this;
  };
  // The the annotation for the `StaveLine`


  StaveLine.prototype.setText = function setText(text) {
  ...
  StaveLine.prototype.setNotes = function setNotes(notes) {
    if (!notes.first_note && !notes.last_note) {
  ...
  StaveLine.prototype.applyLineStyle = function applyLineStyle() {
    var ctx = this.checkContext();
  ...
  StaveLine.prototype.applyFontStyle = function applyFontStyle() {
    var ctx = this.checkContext();
  ...
  StaveLine.prototype.draw = function draw() {
    var _this2 = this;
...
var PedalMarking = exports.PedalMarking = function (_Element) {
  ...
  PedalMarking.createSustain = function createSustain(notes) {
  ...
  PedalMarking.createSostenuto = function createSostenuto(notes) {
    var pedal = new PedalMarking(notes);
  ...
  PedalMarking.createUnaCorda = function createUnaCorda(notes) {
    var pedal = new PedalMarking(notes);
  ...
  PedalMarking.prototype.setCustomText = function setCustomText(depress, release) {
  ...
  PedalMarking.prototype.setStyle = function setStyle(style) {
    if (style < 1 && style > 3) {
  ...
  PedalMarking.prototype.setLine = function setLine(line) {
    this.line = line;return this;
  };
  ...
  PedalMarking.prototype.drawBracketed = function drawBracketed() {
    var ctx = this.context;
  ...
  PedalMarking.prototype.drawText = function drawText() {
    var ctx = this.context;
    var is_pedal_depressed = false;
    var pedal = this;
  ...
  PedalMarking.prototype.draw = function draw() {
    var ctx = this.checkContext();
    this.setRendered();
...
var TextBracket = exports.TextBracket = function (_Element) {
  ...
  TextBracket.prototype.applyStyle = function applyStyle(context) {
  ...
  TextBracket.prototype.setDashed = function setDashed(dashed, dash) {
  ...
  TextBracket.prototype.setFont = function setFont(font) {
  ...
  TextBracket.prototype.setLine = function setLine(line) {
    this.line = line;return this;
  };
  ...
  TextBracket.prototype.draw = function draw() {
    var ctx = this.context;
    this.setRendered();
...
var BarNote = exports.BarNote = function (_Note) {
  ...
  function BarNote() {
    ...
    _this.metrics.widths = (_this$metrics$widths = {}, _this$metrics$widths[TYPE.SINGLE] = 8, _this$metrics$widths[TYPE.DOUBLE] = 12, _this$metrics$widths[TYPE.END] = 15, _this$metrics$widths[TYPE.REPEAT_BEGIN] = 14, _this$metrics$widths[TYPE.REPEAT_END] = 14, _this$metrics$widths[TYPE.REPEAT_BOTH] = 18, _this$metrics$widths[TYPE.NONE] = 0, _this$metrics$widths);
  ...
  BarNote.prototype.getType = function getType() {
    return this.type;
  };

  BarNote.prototype.setType = function setType(type) {
  ...
  BarNote.prototype.preFormat = function preFormat() {
    /* overridden to ignore */
    this.setPreFormatted(true);
    return this;
  };
  ...
  BarNote.prototype.draw = function draw() {
    this.checkContext();
    if (!this.stave) throw new _vex.Vex.RERR('NoStave', "Can't draw without a stave.");
...
var GhostNote = exports.GhostNote = function (_StemmableNote) {
  ...
  function GhostNote(parameter) {
    ...
    var _this = _possibleConstructorReturn(this, _StemmableNote.call(this, note_struct));
  ...
  GhostNote.prototype.isRest = function isRest() {
    return true;
  };

  GhostNote.prototype.setStave = function setStave(stave) {
    _StemmableNote.prototype.setStave.call(this, stave);
  };

  GhostNote.prototype.addToModifierContext = function addToModifierContext() {
    /* intentionally overridden */return this;
  };

  GhostNote.prototype.preFormat = function preFormat() {
    this.setPreFormatted(true);
    return this;
  };

  GhostNote.prototype.draw = function draw() {
    if (!this.stave) throw new _vex.Vex.RERR('NoStave', "Can't draw without a stave.");
...
var System = exports.System = function (_Element) {
  ...
  System.prototype.setOptions = function setOptions() {
    var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  System.prototype.setContext = function setContext(context) {
    _Element.prototype.setContext.call(this, context);
    this.factory.setContext(context);
    return this;
  };

  System.prototype.addConnector = function addConnector() {
  ...
  System.prototype.addStave = function addStave(params) {
    var _this2 = this;
...
var Factory = exports.Factory = function () {
  ...
  Factory.newFromElementId = function newFromElementId(elementId) {
  ...
  Factory.prototype.setContext = function setContext(context) {
    this.context = context;return this;
  };
  ...
  Factory.prototype.getVoices = function getVoices() {
    return this.voices;
  };
  ...
  Factory.prototype.TabStave = function TabStave(params) {
    params = setDefaults(params, {
      x: 0,
      y: 0,
      width: this.options.renderer.width - this.space(1),
  ...
  Factory.prototype.GhostNote = function GhostNote(noteStruct) {
  ...
  Factory.prototype.TextNote = function TextNote(textNoteStruct) {
  ...
  Factory.prototype.BarNote = function BarNote(params) {
    params = setDefaults(params, {
      type: 'single',
      options: {}
    });
  ...
  Factory.prototype.ClefNote = function ClefNote(params) {
    params = setDefaults(params, {
      type: 'treble',
      options: {
        size: 'default'
  ...
  Factory.prototype.TimeSigNote = function TimeSigNote(params) {
    params = setDefaults(params, {
      time: '4/4',
      options: {}
    });
  ...
  Factory.prototype.TabNote = function TabNote(noteStruct) {
  ...
  Factory.prototype.Annotation = function Annotation(params) {
    params = setDefaults(params, {
      text: 'p',
      vJustify: 'below',
      hJustify: 'center',
  ...
  Factory.prototype.Articulation = function Articulation(params) {
    params = setDefaults(params, {
      type: 'a.',
      position: 'above',
      options: {}
  ...
  Factory.prototype.TextDynamics = function TextDynamics(params) {
    params = setDefaults(params, {
      text: 'p',
      duration: 'q',
      dots: 0,
  ...
  Factory.prototype.Fingering = function Fingering(params) {
    params = setDefaults(params, {
      number: '0',
      position: 'left',
      options: {}
  ...
  Factory.prototype.StringNumber = function StringNumber(params) {
    params = setDefaults(params, {
      number: '0',
      position: 'left',
      options: {}
  ...
  Factory.prototype.Formatter = function Formatter() {
    return new _formatter.Formatter();
  };

  Factory.prototype.Tuplet = function Tuplet(params) {
    params = setDefaults(params, {
      notes: [],
      options: {}
    });
  ...
  Factory.prototype.Curve = function Curve(params) {
    params = setDefaults(params, {
      from: null,
      to: null,
      options: {}
  ...
  Factory.prototype.StaveTie = function StaveTie(params) {
    params = setDefaults(params, {
      from: null,
      to: null,
      first_indices: [0],
  ...
  Factory.prototype.StaveLine = function StaveLine(params) {
    params = setDefaults(params, {
      from: null,
      to: null,
      first_indices: [0],
  ...
  Factory.prototype.VibratoBracket = function VibratoBracket(params) {
    params = setDefaults(params, {
      from: null,
      to: null,
      options: {
  ...
  Factory.prototype.TextBracket = function TextBracket(params) {
    params = setDefaults(params, {
      from: null,
      to: null,
      text: '',
  ...
  Factory.prototype.PedalMarking = function PedalMarking() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
  ...
  Factory.prototype.NoteSubGroup = function NoteSubGroup() {
    var params = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
...
var Builder = function () {
  ...
  Builder.prototype.getFactory = function getFactory() {
    return this.factory;
  };
  ...
  Builder.prototype.addCommitHook = function addCommitHook(commitHook) {
  ...
  Builder.prototype.addChord = function addChord(notes) {
    ...
    if (_typeof(notes[0]) !== 'object') {
      ...
      notes.forEach(function (n) {
        if (n) _this8.addNote.apply(_this8, n);
      });
    }
    L('endChord');
  };
...
var EasyScore = exports.EasyScore = function () {
  ...
  EasyScore.prototype.set = function set(defaults) {
  ...
  EasyScore.prototype.addCommitHook = function addCommitHook(commitHook) {
...
var BoundingBoxComputation = exports.BoundingBoxComputation = function () {
  ...
  BoundingBoxComputation.prototype.width = function width() {
    return this.x2 - this.x1;
  };

  BoundingBoxComputation.prototype.height = function height() {
    return this.y2 - this.y1;
  };

  BoundingBoxComputation.prototype.addPoint = function addPoint(x, y) {
    if (x != null) {
  ...
  BoundingBoxComputation.prototype.addX = function addX(x) {
    this.addPoint(x, null);
  };

  BoundingBoxComputation.prototype.addY = function addY(y) {
    this.addPoint(null, y);
  };

  BoundingBoxComputation.prototype.addQuadraticCurve = function addQuadraticCurve(p0x, p0y, p1x, p1y, p2x, p2y) {
  ...
  BoundingBoxComputation.prototype.addBezierCurve = function addBezierCurve(p0x, p0y, p1x, p1y, p2x, p2y, p3x, p3y) {
...
var CanvasContext = exports.CanvasContext = function () {
  ...
  CanvasContext.prototype.clear = function clear() {
  ...
  CanvasContext.prototype.openGroup = function openGroup() {};

  CanvasContext.prototype.closeGroup = function closeGroup() {};

  CanvasContext.prototype.add = function add() {};

  CanvasContext.prototype.setFont = function setFont(family, size, weight) {
    this.vexFlowCanvasContext.font = (weight || '') + ' ' + size + 'pt ' + family;
    return this;
  };

  CanvasContext.prototype.setRawFont = function setRawFont(font) {
    this.vexFlowCanvasContext.font = font;
    return this;
  };

  CanvasContext.prototype.setFillStyle = function setFillStyle(style) {
    this.vexFlowCanvasContext.fillStyle = style;
    return this;
  };

  CanvasContext.prototype.setBackgroundFillStyle = function setBackgroundFillStyle(style) {
    this.background_fillStyle = style;
    return this;
  };

  CanvasContext.prototype.setStrokeStyle = function setStrokeStyle(style) {
    this.vexFlowCanvasContext.strokeStyle = style;
    return this;
  };

  CanvasContext.prototype.setShadowColor = function setShadowColor(style) {
    this.vexFlowCanvasContext.shadowColor = style;
    return this;
  };

  CanvasContext.prototype.setShadowBlur = function setShadowBlur(blur) {
  ...
  CanvasContext.prototype.setLineCap = function setLineCap(cap_type) {
  ...
  CanvasContext.prototype.setLineDash = function setLineDash(dash) {
  ...
  CanvasContext.prototype.resize = function resize(width, height) {
  ...
  CanvasContext.prototype.bezierCurveTo = function bezierCurveTo(x1, y1, x2, y2, x, y) {
    return this.vexFlowCanvasContext.bezierCurveTo(x1, y1, x2, y2, x, y);
  };

  CanvasContext.prototype.quadraticCurveTo = function quadraticCurveTo(x1, y1, x, y) {
  ...
  CanvasContext.prototype.arc = function arc(x, y, radius, startAngle, endAngle, antiClockwise) {
  ...
  CanvasContext.prototype.glow = function glow() {
...
var RaphaelContext = exports.RaphaelContext = function () {
  ...
  RaphaelContext.prototype.openGroup = function openGroup() {};

  RaphaelContext.prototype.closeGroup = function closeGroup() {};

  RaphaelContext.prototype.add = function add() {};

  RaphaelContext.prototype.setFont = function setFont(family, size, weight) {
  ...
  RaphaelContext.prototype.setRawFont = function setRawFont(font) {
    this.attributes.font = font;
    return this;
  };

  RaphaelContext.prototype.setFillStyle = function setFillStyle(style) {
    this.attributes.fill = style;
    return this;
  };

  RaphaelContext.prototype.setBackgroundFillStyle = function setBackgroundFillStyle(style) {
    this.background_attributes.fill = style;
    this.background_attributes.stroke = style;
    return this;
  };

  RaphaelContext.prototype.setStrokeStyle = function setStrokeStyle(style) {
    this.attributes.stroke = style;
    return this;
  };

  RaphaelContext.prototype.setShadowColor = function setShadowColor(style) {
    this.shadow_attributes.color = style;
    return this;
  };

  RaphaelContext.prototype.setShadowBlur = function setShadowBlur(blur) {
    this.shadow_attributes.width = blur;
    return this;
  };

  RaphaelContext.prototype.setLineWidth = function setLineWidth(width) {
  ...
  RaphaelContext.prototype.setLineDash = function setLineDash() {
    return this;
  };

  RaphaelContext.prototype.setLineCap = function setLineCap() {
    return this;
  };

  RaphaelContext.prototype.scale = function scale(x, y) {
  ...
  RaphaelContext.prototype.clear = function clear() {
    this.paper.clear();
  };

  RaphaelContext.prototype.resize = function resize(width, height) {
  ...
  RaphaelContext.prototype.setViewBox = function setViewBox(viewBox) {
    this.paper.canvas.setAttribute('viewBox', viewBox);
  };

  RaphaelContext.prototype.rect = function rect(x, y, width, height) {
    if (height < 0) {
      y += height;
      height = -height;
    }
  ...
  RaphaelContext.prototype.fillRect = function fillRect(x, y, width, height) {
    if (height < 0) {
      y += height;
      height = -height;
    }
  ...
  RaphaelContext.prototype.clearRect = function clearRect(x, y, width, height) {
    if (height < 0) {
      y += height;
      height = -height;
    }
  ...
  RaphaelContext.prototype.beginPath = function beginPath() {
    this.path = '';
    this.pen.x = 0;
    this.pen.y = 0;
    return this;
  ...
  RaphaelContext.prototype.moveTo = function moveTo(x, y) {
    this.path += 'M' + x + ',' + y;
    this.pen.x = x;
    this.pen.y = y;
    return this;
  ...
  RaphaelContext.prototype.lineTo = function lineTo(x, y) {
    this.path += 'L' + x + ',' + y;
    this.pen.x = x;
    this.pen.y = y;
    return this;
  ...
  RaphaelContext.prototype.bezierCurveTo = function bezierCurveTo(x1, y1, x2, y2, x, y) {
  ...
  RaphaelContext.prototype.quadraticCurveTo = function quadraticCurveTo(x1, y1, x, y) {
  ...
  RaphaelContext.prototype.arc = function arc(x, y, radius, startAngle, endAngle, antiClockwise) {
  ...
  RaphaelContext.prototype.arcHelper = function arcHelper(x, y, radius, startAngle, endAngle, antiClockwise) {
  ...
  RaphaelContext.prototype.glow = function glow() {
  ...
  RaphaelContext.prototype.fill = function fill() {
    var elem = this.paper.path(this.path).attr(this.attributes).attr('stroke-width', 0);
    this.glow(elem);
    return this;
  };

  RaphaelContext.prototype.stroke = function stroke() {
  ...
  RaphaelContext.prototype.closePath = function closePath() {
    this.path += 'Z';
    return this;
  };

  RaphaelContext.prototype.measureText = function measureText(text) {
  ...
  RaphaelContext.prototype.restore = function restore() {
...
var SVGContext = exports.SVGContext = function () {
  ...
  SVGContext.prototype.create = function create(svgElementType) {
  ...
  SVGContext.prototype.openGroup = function openGroup(cls, id, attrs) {
  ...
  SVGContext.prototype.closeGroup = function closeGroup() {
    this.groups.pop();
    this.parent = this.groups[this.groups.length - 1];
  };

  SVGContext.prototype.add = function add(elem) {
  ...
  SVGContext.prototype.iePolyfill = function iePolyfill() {
  ...
  SVGContext.prototype.setFont = function setFont(family, size, weight) {
  ...
  SVGContext.prototype.setRawFont = function setRawFont(font) {
    font = font.trim();
  ...
  SVGContext.prototype.setFillStyle = function setFillStyle(style) {
    this.attributes.fill = style;
    return this;
  };

  SVGContext.prototype.setBackgroundFillStyle = function setBackgroundFillStyle(style) {
    this.background_attributes.fill = style;
    this.background_attributes.stroke = style;
    return this;
  };

  SVGContext.prototype.setStrokeStyle = function setStrokeStyle(style) {
    this.attributes.stroke = style;
    return this;
  };

  SVGContext.prototype.setShadowColor = function setShadowColor(style) {
    this.shadow_attributes.color = style;
    return this;
  };

  SVGContext.prototype.setShadowBlur = function setShadowBlur(blur) {
    this.shadow_attributes.width = blur;
    return this;
  };

  SVGContext.prototype.setLineWidth = function setLineWidth(width) {
    this.attributes['stroke-width'] = width;
    this.lineWidth = width;
  };
  ...
  SVGContext.prototype.setLineDash = function setLineDash(lineDash) {
  ...
  SVGContext.prototype.setLineCap = function setLineCap(lineCap) {
  ...
  SVGContext.prototype.resize = function resize(width, height) {
    this.width = width;
    this.height = height;
    this.element.style.width = width;
    var attributes = {
  ...
  SVGContext.prototype.scale = function scale(x, y) {
  ...
  SVGContext.prototype.setViewBox = function setViewBox() {
    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }
  ...
  SVGContext.prototype.clear = function clear() {
  ...
  SVGContext.prototype.rect = function rect(x, y, width, height, attributes) {
  ...
  SVGContext.prototype.fillRect = function fillRect(x, y, width, height) {
    if (height < 0) {
      y += height;
      height *= -1;
    }
  ...
  SVGContext.prototype.clearRect = function clearRect(x, y, width, height) {
  ...
  SVGContext.prototype.beginPath = function beginPath() {
    this.path = '';
    this.pen.x = 0;
    this.pen.y = 0;
    return this;
  ...
  SVGContext.prototype.moveTo = function moveTo(x, y) {
    this.path += 'M' + x + ' ' + y;
    this.pen.x = x;
    this.pen.y = y;
    return this;
  ...
  SVGContext.prototype.lineTo = function lineTo(x, y) {
    this.path += 'L' + x + ' ' + y;
    this.pen.x = x;
    this.pen.y = y;
    return this;
  ...
  SVGContext.prototype.bezierCurveTo = function bezierCurveTo(x1, y1, x2, y2, x, y) {
    this.path += 'C' + x1 + ' ' + y1 + ',' + x2 + ' ' + y2 + ',' + x + ' ' + y;
    this.pen.x = x;
    this.pen.y = y;
    return this;
  ...
  SVGContext.prototype.quadraticCurveTo = function quadraticCurveTo(x1, y1, x, y) {
    this.path += 'Q' + x1 + ' ' + y1 + ',' + x + ' ' + y;
    this.pen.x = x;
    this.pen.y = y;
    return this;
  ...
  SVGContext.prototype.arc = function arc(x, y, radius, startAngle, endAngle, antiClockwise) {
    function normalizeAngle(angle) {
      while (angle < 0) {
        angle += Math.PI * 2;
      }
  ...
  SVGContext.prototype.arcHelper = function arcHelper(x, y, radius, startAngle, endAngle, antiClockwise) {
    var x1 = x + radius * Math.cos(startAngle);
    var y1 = y + radius * Math.sin(startAngle);
  ...
  SVGContext.prototype.closePath = function closePath() {
    this.path += 'Z';
  ...
  SVGContext.prototype.glow = function glow() {
  ...
  SVGContext.prototype.fill = function fill(attributes) {
  ...
  SVGContext.prototype.stroke = function stroke() {
    // If our current path is set to glow, make it glow.
    this.glow();
  ...
  SVGContext.prototype.measureText = function measureText(text) {
  ...
  SVGContext.prototype.ieMeasureTextFix = function ieMeasureTextFix(bbox) {
  ...
  SVGContext.prototype.fillText = function fillText(text, x, y) {
    var attributes = {};
    _vex.Vex.Merge(attributes, this.attributes);
    attributes.stroke = 'none';
    attributes.x = x;
  ...
  SVGContext.prototype.save = function save() {
    // TODO(mmuthanna): State needs to be deep-copied.
    this.state_stack.push({
      state: {
  ...
  SVGContext.prototype.restore = function restore() {
    // TODO(0xfe): State needs to be deep-restored.
    var state = this.state_stack.pop();
...
var StaveSection = exports.StaveSection = function (_StaveModifier) {
  ...
  StaveSection.prototype.getCategory = function getCategory() {
    return StaveSection.CATEGORY;
  };

  StaveSection.prototype.setStaveSection = function setStaveSection(section) {
    this.section = section;return this;
  };

  StaveSection.prototype.setShiftX = function setShiftX(x) {
    this.shift_x = x;return this;
  };

  StaveSection.prototype.setShiftY = function setShiftY(y) {
    this.shift_y = y;return this;
  };

  StaveSection.prototype.draw = function draw(stave, shift_x) {
    var ctx = stave.checkContext();
    this.setRendered();
...
var StaveTempo = exports.StaveTempo = function (_StaveModifier) {
  ...
  StaveTempo.prototype.getCategory = function getCategory() {
    return StaveTempo.CATEGORY;
  };

  StaveTempo.prototype.setTempo = function setTempo(tempo) {
    this.tempo = tempo;return this;
  };

  StaveTempo.prototype.setShiftX = function setShiftX(x) {
    this.shift_x = x;return this;
  };

  StaveTempo.prototype.setShiftY = function setShiftY(y) {
    this.shift_y = y;return this;
  };

  StaveTempo.prototype.draw = function draw(stave, shift_x) {
    var ctx = stave.checkContext();
    this.setRendered();
...
var StaveText = exports.StaveText = function (_StaveModifier) {
  ...
  StaveText.prototype.getCategory = function getCategory() {
    return StaveText.CATEGORY;
  };

  StaveText.prototype.setStaveText = function setStaveText(text) {
    this.text = text;return this;
  };

  StaveText.prototype.setShiftX = function setShiftX(x) {
    this.shift_x = x;return this;
  };

  StaveText.prototype.setShiftY = function setShiftY(y) {
    this.shift_y = y;return this;
  };

  StaveText.prototype.setFont = function setFont(font) {
    _vex.Vex.Merge(this.font, font);
  };

  StaveText.prototype.setText = function setText(text) {
    this.text = text;
  };

  StaveText.prototype.draw = function draw(stave) {
    var ctx = stave.checkContext();
    this.setRendered();
...
var TabSlide = exports.TabSlide = function (_TabTie) {
  ...
  TabSlide.createSlideUp = function createSlideUp(notes) {
    return new TabSlide(notes, TabSlide.SLIDE_UP);
  };

  TabSlide.createSlideDown = function createSlideDown(notes) {
  ...
  function TabSlide(notes, direction) {
    ...
    var _this = _possibleConstructorReturn(this, _TabTie.call(this, notes, 'sl.'));
    /**
     * Notes is a struct that has:
     *
     *  {
  ...
  TabSlide.prototype.renderTie = function renderTie(params) {
    if (params.first_ys.length === 0 || params.last_ys.length === 0) {
      throw new _vex.Vex.RERR('BadArguments', 'No Y-values to render');
    }
...
var GraceTabNote = exports.GraceTabNote = function (_TabNote) {
  ...
  function GraceTabNote(note_struct) {
    ...
    var _this = _possibleConstructorReturn(this, _TabNote.call(this, note_struct, false));
  ...
  GraceTabNote.prototype.getCategory = function getCategory() {
    return GraceTabNote.CATEGORY;
  };

  GraceTabNote.prototype.draw = function draw() {
    _TabNote.prototype.draw.call(this);
    this.setRendered();
  };
...
var Tuning = exports.Tuning = function () {
  ...
  Tuning.prototype.noteToInteger = function noteToInteger(noteString) {
    return _tables.Flow.keyProperties(noteString).int_value;
  };

  Tuning.prototype.setTuning = function setTuning(noteString) {
  ...
  Tuning.prototype.getValueForString = function getValueForString(stringNum) {
  ...
  Tuning.prototype.getValueForFret = function getValueForFret(fretNum, stringNum) {
  ...
  Tuning.prototype.getNoteForFret = function getNoteForFret(fretNum, stringNum) {
...
var KeyManager = exports.KeyManager = function () {
  ...
  KeyManager.prototype.setKey = function setKey(key) {
    this.key = key;
    this.reset();
    return this;
  };

  KeyManager.prototype.getKey = function getKey() {
    return this.key;
  };

  KeyManager.prototype.reset = function reset() {
  ...
  KeyManager.prototype.getAccidental = function getAccidental(key) {
  ...
  KeyManager.prototype.selectNote = function selectNote(note) {
...
var StaveHairpin = exports.StaveHairpin = function (_Element) {
   ...
   *
   **/
  StaveHairpin.FormatByTicksAndDraw = function FormatByTicksAndDraw(ctx, formatter, notes, type, position, options) {
  ...
  StaveHairpin.prototype.setPosition = function setPosition(position) {
  ...
  StaveHairpin.prototype.setRenderOptions = function setRenderOptions(options) {
  ...
  StaveHairpin.prototype.setNotes = function setNotes(notes) {
    if (!notes.first_note && !notes.last_note) {
  ...
  StaveHairpin.prototype.renderHairpin = function renderHairpin(params) {
    var ctx = this.checkContext();
  ...
  StaveHairpin.prototype.draw = function draw() {
    this.checkContext();
    this.setRendered();
...
var Tremolo = exports.Tremolo = function (_Modifier) {
  ...
  Tremolo.prototype.getCategory = function getCategory() {
    return Tremolo.CATEGORY;
  };

  Tremolo.prototype.draw = function draw() {
    this.checkContext();
...
var Crescendo = exports.Crescendo = function (_Note) {
  ...
  Crescendo.prototype.setLine = function setLine(line) {
    this.line = line;return this;
  };
  ...
  Crescendo.prototype.setHeight = function setHeight(height) {
  ...
  Crescendo.prototype.setDecrescendo = function setDecrescendo(decresc) {
  ...
  Crescendo.prototype.preFormat = function preFormat() {
  ...
  Crescendo.prototype.draw = function draw() {
    this.checkContext();
    this.setRendered();
